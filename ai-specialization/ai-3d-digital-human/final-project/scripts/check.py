...
check("前端页面目录存在", dir_exists("frontend/src/views") or dir_exists("frontend/src/pages"))
check("前端服务目录存在", dir_exists("frontend/src/services"))
...
print("\n🔧 核心服务：")
check("数字人驱动服务存在",
      dir_exists("backend/app/services/digital_human") or
      dir_exists("backend/app/services/avatar") or
      dir_exists("backend/app/services/digital-human"))
check("TTS 服务存在",
      dir_exists("backend/app/services/tts") or
      dir_exists("backend/app/services/speech"))
check("对话引擎存在",
      dir_exists("backend/app/services/dialogue") or
      dir_exists("backend/app/services/chat") or
      dir_exists("backend/app/services/conversation"))

# ── 5. 模型目录 ──
print("\n📦 模型：")
check("models/ 目录存在", dir_exists("models"))
