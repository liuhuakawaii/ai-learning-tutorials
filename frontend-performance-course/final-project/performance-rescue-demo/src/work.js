...
searchInput.addEventListener('input', (event) => {
  ...
  window.perfRescue.measureInteraction('SearchInputWork', start);
});
...
sortButton.addEventListener('click', () => {
  ...
  window.perfRescue.measureInteraction('SortProductsWork', start);
});
...
addButton.addEventListener('click', () => {
  ...
  window.perfRescue.measureInteraction('AddToCartWork', start);
});
