...
这个仓库存放了我利用 AI 生成的各类技术学习教程。课程主要面向已有前端基础的学习者，帮助你从零补齐后端开发、数据采集、AI 应用、性能工程与部署能力。仓库包含一条完整的 **AI 工程师学习路径**（7 门课程 + 毕业项目），以及 AI 专项、前端、后端、工程运维、数据等方向的系统课程，共 **53 门课程、约 1559 课时**。所有重点课程都配有贯穿式 final project / project kit，方便边学边验证。
...
│   ├── 01-ai-app/                     # AI 应用开发基础
│   ├── 02-ai-agent-engineer/          # AI Agent 全栈工程师
│   ├── 03-llm-eval/                   # LLM 评估与可观测性
│   ├── 04-multi-agent/                # 多 Agent 编排
│   ├── 05-mcp-dev/                    # MCP 协议深度开发
│   ├── 06-llm-finetuning/             # 开源模型部署与微调
│   ├── 07-multimodal-ai/              # 多模态 AI 应用
│   └── graduation-project/            # 毕业项目：AI 数据分析平台
│
├── ai-specialization/                 # AI 专项进阶
│   ├── prompt-engineering/            # Prompt Engineering 深度课
│   ├── rag-engineering/               # RAG 工程化
│   ├── ai-security/                   # AI 安全与对抗
│   ├── ai-coding-engineering/         # AI 编程工程
│   ├── ai-product/                    # AI 产品化实战
│   ├── ai-3d-digital-human/           # AI + 3D 生成与数字人
│   ├── ai-image-workflow/             # AI 图像编辑与生成工作流
│   ├── ai-data-visualization/         # AI 数据可视化与智能报表
│   ├── ai-code-migration/             # AI 代码迁移与遗留系统现代化
│   └── quant-trading-ai/             # 量化交易与金融 AI
│
├── frontend/                          # 前端方向
│   ├── nextjs-fullstack/              # Next.js 全栈产品
│   ├── frontend-performance/          # 前端性能工程
│   ├── graphics-shader/               # 3D 图形学与 Shader
│   ├── react-native/                  # React Native 移动端
│   ├── ar-vr-xr/                      # AR/VR/XR 空间计算
│   ├── webassembly/                   # WebAssembly 高性能 Web 开发
│   ├── motion-design/                 # 技术动画与动效
│   ├── browser-extension/             # 浏览器扩展开发
│   ├── audio-video-engineering/       # 音视频工程
│   ├── threejs-architecture/          # Three.js 3D 架构设计
│   ├── immersive-3d-web/              # 沉浸式 3D Web 体验
│   ├── shader-art/                    # Shader 艺术创作
│   ├── webgpu-creative/               # WebGPU 创意编程
│   ├── generative-art-algorithms/     # 生成艺术与算法
│   ├── game-physics-engine/           # 游戏物理引擎
│   ├── 3d-data-visualization/         # 3D 数据可视化
│   ├── procedural-world-generation/   # 程序化世界生成
│   └── performance-profiling/         # 性能分析与调优
│
├── backend/                           # 后端方向
│   ├── nodejs-backend/                # 全栈后端开发
│   ├── typescript-engineering/        # TypeScript 工程化
│   ├── python-spider/                 # Python 爬虫
│   ├── python-automation/             # Python 自动化脚本
│   ├── http-deep-dive/                # HTTP 协议深度解析
│   ├── networking-deep-dive/          # 计算机网络深度探索
│   └── os-for-developers/             # 面向开发者的操作系统
│
├── devops/                            # 工程与运维
│   ├── docker-cicd/                   # Docker 与 CI/CD
│   ├── kubernetes-cloud/              # 云原生与 Kubernetes
│   ├── testing-qa/                    # 测试与质量保障
│   ├── system-design/                 # 系统设计与架构
│   ├── lowcode-platform/              # 低代码/无代码平台
│   ├── workflow-automation/           # 自动化工作流
│   ├── engineering-leadership/        # 工程管理与技术领导力
│   └── github-actions-deep-dive/      # GitHub Actions 深度实践
│
├── data/                              # 数据方向
│   ├── data-product/                  # 数据产品化
│   └── search-engine/                 # 搜索引擎工程
│
├── README.md
├── AGENTS.md
